...
new class extends _identity {
  static [class EveSOFDataHullExtensionPlacementDistributionMapGraphicSettings extends CjsModel {
    static {
      ({
        ...
        family: "eve"
      })], [[[io, io.persist, type, type.int32, void 0, schema.enum("DisplayQualityModifier")], 16, "displayFilter"], [[io, io.persist, type, type.string], 16, "name"]], 0, void 0, CjsModel));
    }
    constructor(...args) {
      super(...args);
