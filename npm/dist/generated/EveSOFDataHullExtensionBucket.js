...
class EveSOFDataHullExtensionBucket extends CjsModel {
  static {
    ({
      ...
      family: "eve"
    })], [[[io, io.persist, void 0, type.list("EveSOFDataDistributionDepletionCounter")], 16, "depletionCounters"], [[io, io.persist, type, type.string], 16, "name"], [[io, io.persist, void 0, type.list("EveSOFDataHullExtensionPlacement")], 16, "placements"]], 0, void 0, CjsModel));
  }
  constructor(...args) {
    super(...args);
