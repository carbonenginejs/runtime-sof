...
import { EveSOFDataDecalIndexBuffer } from "../npm/dist/generated/EveSOFDataDecalIndexBuffer.js";
import { EveSOFDataHull } from "../npm/dist/generated/EveSOFDataHull.js";
import { EveSOFDataHullBanner } from "../npm/dist/generated/EveSOFDataHullBanner.js";
import { EveSOFDataHullBannerSetItem } from "../npm/dist/generated/EveSOFDataHullBannerSetItem.js";
import { EveSOFDataHullChild } from "../npm/dist/generated/EveSOFDataHullChild.js";
import { EveSOFDataHullChildSet } from "../npm/dist/generated/EveSOFDataHullChildSet.js";
import { EveSOFDataHullChildSetItem } from "../npm/dist/generated/EveSOFDataHullChildSetItem.js";
import { EveSOFDataHullController } from "../npm/dist/generated/EveSOFDataHullController.js";
import { EveSOFDataHullDecalSetItem } from "../npm/dist/generated/EveSOFDataHullDecalSetItem.js";
import { EveSOFDataHullHazeSet } from "../npm/dist/generated/EveSOFDataHullHazeSet.js";
import { EveSOFDataHullLightSetItem } from "../npm/dist/generated/EveSOFDataHullLightSetItem.js";
import { EveSOFDataHullLightSetSpotLight } from "../npm/dist/generated/EveSOFDataHullLightSetSpotLight.js";
import { EveSOFDataHullLightSetTexturedPointLight } from "../npm/dist/generated/EveSOFDataHullLightSetTexturedPointLight.js";
import { EveSOFDataHullPlaneSet } from "../npm/dist/generated/EveSOFDataHullPlaneSet.js";
import { EveSOFDataHullSpotlightSet } from "../npm/dist/generated/EveSOFDataHullSpotlightSet.js";
import { EveSOFDataHullSpotlightSetItem } from "../npm/dist/generated/EveSOFDataHullSpotlightSetItem.js";
...
test("SOF emits and hydrates visible Carbon hull light types with cumulative hull offsets", {
  ...
  const pointData = referencedNode(document, lights[0].fields.lightData);
  assert.equal(pointData.kind, "LightData");
  assert.deepEqual(pointData.fields.position, [1, 2, 3]);
  assert.deepEqual(pointData.fields.color, [0.25, 0.5, 0.75, 1]);
  assert.equal(pointData.fields.radius, 4);
  assert.equal(pointData.fields.flags, 9);
  assert.equal(pointData.fields.boneIndex, 7);
  const texturedData = referencedNode(document, lights[1].fields.lightData);
  assert.equal(texturedData.fields.texturePath, "res:/light.dds");
  const spotData = referencedNode(document, lights[2].fields.lightData);
  assert.equal(spotData.fields.innerAngle, 0.4);
  assert.equal(spotData.fields.outerAngle, 0.8);
  const secondHullData = referencedNode(document, lights[3].fields.lightData);
  assert.deepEqual(secondHullData.fields.position, [11, 0, 0]);
  ...
  assert.deepEqual(hydrated.reports, []);
  assert.equal(hydrated.root.lights[0].lightData.constructor.name, "LightData");
...
test("SOF emits and hydrates Carbon impact overlays and preserves the HULL shield quirk", {
  ...
  assert.deepEqual(overlay.armorImpactEmitter.GetEmitterData().minSpeed, 3);
  assert.deepEqual(Array.from(overlay.armorImpactEmitter.GetEmitterParams().colors[2]), [0, 0, 1, 0.5]);
