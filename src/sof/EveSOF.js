...
import { EveSOFDataHullDecalSetItem } from "../generated/EveSOFDataHullDecalSetItem.js";
import { EveSOFDataHullBanner } from "../generated/EveSOFDataHullBanner.js";
import { EveSOFDataHullBannerSetItem } from "../generated/EveSOFDataHullBannerSetItem.js";
import { EveSOFDataHullHazeSet } from "../generated/EveSOFDataHullHazeSet.js";
import { EveSOFDataHullLightSetItem } from "../generated/EveSOFDataHullLightSetItem.js";
import { EveSOFDataHullPlaneSet } from "../generated/EveSOFDataHullPlaneSet.js";
import { EveSOFDataHull } from "../generated/EveSOFDataHull.js";
import { EveSOFDataArea } from "../generated/EveSOFDataArea.js";
import { EveSOFDataInstancedMesh } from "../generated/EveSOFDataInstancedMesh.js";
...
export class EveSOF extends CjsModel
{
  ...
  SetupAttachments(document, rootFields, dna, offsets = [identityMatrix()], isInstancedPlacement = false)
  {
    ...
    if (dna.GetBuildClass() !== EveSOFDataHull.BuildClass.BUILDCLASS_EXTENSION)
    {
              ...
              if (item.light)
              {
                ...
                for (let spriteIndex = 0; spriteIndex < positions.length; spriteIndex++)
                {
                  lightRotation = Array.from(quat.normalize(
                    quat.create(),
                    quat.multiply(quat.create(), lightRotation, line.rotation)
                  ));
  ...
  SetupLocatorSets(document, rootFields, dna)
  {
    ...
    {
      rootFields.locatorSets.push(document.AddNode("EveLocatorSets", { name, locators }));
    }
  }
